...
export function ProjectCard() {
    const [project, setProject] = useState<Project>({id: 0, name: "", tasks: []});
    ...
    <div className="flex align-middle justify-center items-center w-full h-40">
        ...
        <button onClick={addProject} type='submit' className='w-30 h-8 border rounded-sm transform transition duration-300 hover:scale-110' >Add Task</button>
        </div>
        <br/>
        <div>
